	...
	if($lista_cli06 == false){
	   ...
	   if($lista_cli_06_count > 1 && $pg <= $lista_cli_06_count){
	   	  echo "<div class='clearfix colelem' id='u365428'>";
	   		if($pg > 1){
	   			echo "
			        <div class='rounded-corners clearfix grpelem' id='u365430-4' style='cursor: pointer;' onclick='paginacao_pedidos($pg - 1)' data-muse-uid='U365430' data-muse-type='txt_frame'><!-- content -->
	   		...
	   		if($pg < $lista_cli_06_count){
	   			...
	   			echo "
			        <div class='rounded-corners clearfix grpelem' id='u365429-4' style='cursor: pointer;' onclick='paginacao_pedidos($pg + 1)' data-muse-uid='U365429' data-muse-type='txt_frame'><!-- content -->
