...
if($servico != " " && $estado != " " && $cidade != " " && $id_foto != null){
	...
	if($lista_cli06 == false){
	   ...
	   if($lista_cli_06_count > 1 && $pg <= $lista_cli_06_count){
	   	  echo "<div class='clearfix colelem shared_content' style='margin-left: 50%;' id='u364008' data-content-guid='u364008_content'>";
	   		if($pg > 1){
	   			echo "
			        <div class='rounded-corners clearfix grpelem' id='u366291-4' style='cursor: pointer;' onclick='paginacao_pedidos($pg - 1)' data-muse-uid='U366291' data-muse-type='txt_frame'><!-- content -->
			          <p id='u366291-2'><span id='u366291'>ANTERIOR</span></p>
			        </div>
	   			";
	   		}else{
	   			echo"<div class='rounded-corners clearfix grpelem' id='u366291-4' data-muse-uid='U366291' data-muse-type='txt_frame'><!-- content -->
			          <p id='u366291-2'><span id='u366291'>ANTERIOR</span></p>
			        </div>";
	   		}
	   		...
	   		if($pg < $lista_cli_06_count){
	   			...
	   			echo "
			        <div class='rounded-corners clearfix grpelem' id='u366290-4' style='cursor: pointer;' onclick='paginacao_pedidos($pg + 1)' data-muse-uid='U366290' data-muse-type='txt_frame'><!-- content -->
			         <p id='u366290-2'><span id='u366290'>PROXIMO</span></p>
			        </div>
	   			";
