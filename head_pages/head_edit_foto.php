...
<?php session_start(); require('connection.php'); $conexao = mysqli_connect($db_host, $db_user, $db_pass, $db_name);
     ...
     <?php 
       ...
       if($val_foto_email != " " && $val_foto_senha != " " && $val_foto_ident = "FF"){ // Val e lista fotografo físico
            $sql2 = sprintf("select fs.foto_fisi_nome as 'nome', fs.foto_fisi_email as 'email', f.foto_img_perf as 'imagem', f.foto_dir as 'dir', f.foto_edicao as 'edicao',
                f.foto_credito as 'credito', fs.foto_fisi_cpf as 'cpf', fs.foto_fisi_tel as 'tel', fs.foto_fisi_cel as 'cel', fs.foto_fisi_nome_emp as 'nome_emp',
        ...
        and fs.foto_fisi_email = '%s' and fs.foto_fisi_senha = '%s'",$val_foto_email, $val_foto_senha);
            ...
            $edicao_array = explode(",", $cli_edicao);
            ...
            $sql3 = sprintf("select fj.foto_juri_nome_fan as 'nome', fj.foto_juri_email as 'email', f.foto_img_perf as 'imagem', f.foto_dir as 'dir', f.foto_edicao as 'edicao',
