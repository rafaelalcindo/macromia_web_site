	...
	//	echo "<h3>No momento estamos sem eventos</h3>";
		...
		if($lista_cli_01_count > 1 && $pg <= $lista_cli_01_count){
			echo "<div class='clearfix colelem shared_content' id='u364008' style='margin-left: 50%;' data-content-guid='u364008_content'>";
	   		if($pg > 1){
	   		    echo"
	   				<div class='rounded-corners clearfix grpelem' id='u367152-4' style='cursor: pointer;' onclick='paginacao_pedidos($pg - 1, true)' data-muse-uid='U367152' data-muse-type='txt_frame'><!-- content -->
	   		...
	   		if($pg < $lista_cli_01_count){

	   			echo "
	   				<div class='rounded-corners clearfix grpelem' id='u367151-4' style='cursor: pointer;' onclick='paginacao_pedidos($pg + 1, true)' data-muse-uid='U367151' data-muse-type='txt_frame'><!-- content -->
			          <p id='u367151-2'><span id='u367151'>PRÓXIMO</span></p>
			        </div>
	   			";
