...
if($servico != " " && $estado != " " && $cidade != " " && $id_foto != null){
	...
	//	echo "<h3>No momento estamos sem eventos</h3>";
		...
		if($lista_cli_01_count > 1 && $pg <= $lista_cli_01_count){
			echo "<div class='clearfix colelem shared_content' style='margin-left: 50%; margin-top: 13%;' id='u364008' data-content-guid='u364008_content'>";
	   		if($pg > 1){
	   			echo "
			        <div class='rounded-corners clearfix grpelem' id='u366291-4' style='cursor: pointer;' onclick='paginacao_pedidos($pg - 1, true)' data-muse-uid='U366291' data-muse-type='txt_frame'><!-- content -->
	   		...
	   		if($pg < $lista_cli_01_count){
	   			...
	   			echo "
			        <div class='rounded-corners clearfix grpelem' id='u366290-4' style='cursor: pointer;' onclick='paginacao_pedidos($pg + 1, true)' data-muse-uid='U366290' data-muse-type='txt_frame'><!-- content -->
